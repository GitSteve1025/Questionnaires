...
const showData=()=>{
  ...
  post('/questionnaires/find',{
    ...
    console.log(message)
    for(let question of message.choiceQuestions){
      choiceQuestions.push(question); // 将后端返回的问题数组存储到question中
...
<template>
  <div>
    ...
    <!--表格组件-->
    <el-table :data="blankQuestions" @selection-change="selected" border style="margin-top: 100px; margin-left: 40px;">
      ...
      <el-table-column prop="choices" label="问题选项" width="100"/>
